...
export default function NewArrival() {
  ...
  const [bestCollectionProducts, setBestCollectionProducts] = useState(products.slice(8,11))

 

  return (
    <div className="bg-[#FADAD2] pb-14">
      <div >
        <div className="py-5" >
                ...
                <div className="flex justify-center items-center flex-col ">
                  <div className="drop-shadow-lg bg-white flex justify-center flex-col items-center mx-5 mt-5  ">
                    ...
                    <div className="bg-[#003B29] text-white p-3">
                      <h2>{product.title.slice(0,35)} - {product.desc.slice(0,19)}...</h2>
