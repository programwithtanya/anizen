  ...
  <div>
    {location.pathname === '/' && <div>
      <footer class="bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left">
        ...
        <div class="mx-6 py-10 text-center md:text-left">
          <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div class="">
              ...
              <p>
                We offer a curated selection of high-quality merchandise, from
                action figures and plushies to apparel and accessories.
              </p>
            </div>
            <div>
        ...
        <div class="bg-black/5 p-6 text-center flex justify-center">
          <span>© 2024 Copyright:</span>
          {/* <a class="font-semibold" href="https://tw-elements.com/"
      >TW Elements</a
    > */}
          <div className="font-semibold">Anizen</div>
        </div>
      </footer>
    </div>}
  </div>
